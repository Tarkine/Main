...
let dialogue = [
    ...
    "The fuse is a button. when they click on it it will load the next page.",//19
    "nice.",//20
    ...
    "Place the fuse in the boat.",//24
    "Head back to where you were on the trail.",//25
    "Place the stone in the recess.",//26
    "the stone does nothing (because Ethan doesn’t want to have to code more glowing rocks...Ethan...)",//27
    "Head back to the gate.",//28
    "Grab the Stone.",//29
    "Stare at the stone.",//30
    "Grab the Stone and head back to the clearing.",//31
    "Stare at the stone.",//32
    "Head back to the boat and attach the steering wheel.",//33
    "Throw rock at the bird.",//34
    "Throw stone at the bird.",//35
    "Pursue the bird.",//36
    "Chase the bird.",//37
    "Head back to the Boat.",//38
    "Place items in the boat.",//39
    "Just vibe."//40
]
...
const page20 = {
    ...
    response2 : storyContentArray[12],
    background : '',
...
const page27 = {
    ...
    choice1 : dialogue[32],
    choice2 : dialogue[33],
    response1 : storyContentArray[16],
    response2 : storyContentArray[16],
    background : '',
